...
public class ModelCache implements ISelectiveResourceReloadListener {
    ...
    public static final Function<ResourceLocation, TextureAtlasSprite> DEFAULTTEXTUREGETTER	= texture -> new FakeAtlasSprite(texture);
    ...
    public IModel getModel(final ResourceLocation location) {
        ...
        if(model == null) {
            try {
                ...
                OpenHeli.logger.error("Could not load model");
